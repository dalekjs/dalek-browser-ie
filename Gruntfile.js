...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    documantix: {
      options: {
        ...
        target: 'report/docs',
        vars: {
          title: 'DalekJS - Documentation - Browser - Internet Explorer',
          desc: 'DalekJS - Documentation - Browser - Internet Explorer',
          docs: true
        }
      },
      src: ['index.js']
  ...
  grunt.registerTask('preparePlato', function () {
    ...
    var platoDummyFolders = ['report', 'report/coverage', 'report/complexity', 'report/complexity/files', 'report/complexity/files/test', 'report/complexity/files/index_js', 'report/complexity/files/install_js', 'report/complexity/files/lib_iedriver_js'];
    var platoDummyFiles = ['/report/complexity/report.history.json', '/report/complexity/files/report.history.json', '/report/complexity/files/index_js/report.history.json', '/report/complexity/files/install_js/report.history.json', '/report/complexity/files/lib_iedriver_js/report.history.json'];
